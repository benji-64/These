...
\paragraph{Emergence de l'économie de l'expérience} A
%\paragraph{Le marketing traditionnel} 

Le passage de l'ère industriel à l'ère informationnelle a généré l'émergence de l'économie de l'expérience, un terme inventé par \textcite{pine99} pour décrire l'étape succédant à l'économie de services. L'économie de l'expérience ne se contente plus de vendre des services intangibles et se concentre sur la vente d'une expérience mémorable. D'après \textcite{pine99}, cette nouvelle approche à la transaction économique permet de : se différencier de ses compétiteurs, vendre plus cher, constamment renouveler son produit a bas efforts et de créer une valeur continue dans le temps pour le consommateur. \par 


\paragraph{L'expérience est prise en compte dans le marketing} B

Cette prise en compte de l'expérience des consommateurs a donné lieu à une transformation profonde de l'approche marketing des entreprises que \textcite{schmitt99} décrit comme la transition d'un marketing traditionnel à un marketing expérientiel. Le marketing traditionnel repose sur les spécificités du produit et des catégories de produit, de secteur et de rivaux précis ; il considère les clients comme rationnels et réfléchis et il utilisent des méthodes principalement quantitatives et analytiques. À l'inverse, le marketing expérientiel se concentre sur l'expérience client ; il approche la consommation comme une expérience holistique ; il considère les clients comme des être rationnels et émotionnels et enfin le marketing expérientiel utilise des méthodes diverses et variées. \par 

\paragraph{Prise en compte de l'expérience client} C

L'idée selon laquelle les consommateurs désirent des expériences plutôt que des biens et services est déjà abordée dans les années 1950 \parencites{abbott55, alderson57, levy59, gardner55}. 




\paragraph{La relation client est essentielle dans l'expérience du client}

\paragraph{L'expérience client qu'est ce que c'est ?}

\paragraph{L'expérience client d'où ça vient}
