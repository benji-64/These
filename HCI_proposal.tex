...
Les premières tentatives de classification des réactions des consommateurs face à l'insatisfaction apparaissent avec \textcite{hirschman70}, qui identifient trois formes de réponses : « exit », « voice » et « loyalty ». Le terme « exit » renvoie à la décision du consommateur d'éviter les produits ou services d'une entreprise. « Voice » désigne l'expression directe d'une plainte auprès de l'organisation, par exemple via des canaux en ligne. Enfin, « loyalty » correspond à l'absence d'action de la part du consommateur malgré son mécontentement. \par 
...
Enfin, \textcite{singh88} affinent ces approches en distinguant trois grandes catégories de réponses à l'insatisfaction : \textbf{les réponses privées} (par exemple le bouche-à-oreille), \textbf{les réponses publiques aux acteurs impliqués} dans la transaction (telles que la réclamation directe auprès de l'entreprise) et \textbf{les réponses publiques aux acteurs non-impliqués} dans la transaction (comme le recours à une agence de protection du consommateur ou à une action en justice).\par % Cette classification s’est imposée comme l’une des plus utilisées dans la littérature sur les réclamations clients . \par
...
Relire \textcite{nimako12, panda14} pour la taxonomie la plus utilisée.


\paragraph{Les enjeux de la gestion des réclamations} E
...
Voir \textcite{verhoef10} pour customer engagement et WOM

La gestion des réclamations clients constitue un enjeu essentiel pour toute organisation, qu’il s’agisse de leur collecte, de leur analyse ou de la formulation de réponses appropriées. Une réclamation émanant d’un client constitue une source précieuse d’informations pour l’amélioration continue \parencite{harari92}

gestion des réclamations représente un levier déterminant pour perfectionner la conception et la prestation des biens et services \parencite{tax1998}.

un client qui exprime une plainte est un client encore impliqué, qui manifeste un intérêt résiduel envers l’organisation \parencite{harari92} \parencite{richard95}. 
